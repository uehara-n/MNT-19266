...
<div id="seko_single">
		...
		<a href="<? echo gr_get_image_src('seko_after_image'); ?>" rel="lightbox[seko]" ><? echo gr_get_image( 'seko_after_image', array( 'width' => 300) ); ?></a><?php
 ?>
		<? } else if(get_post_meta($post->ID,'seko_csv2',true)): ?>
		<p class="after_pic"><a href="/wp-content/themes/gaiheki/page_image<?php echo post_custom( 'seko_csv2' ); ?>" rel="lightbox[seko]"><img src="/wp-content/themes/gaiheki/page_image<?php echo post_custom( 'seko_csv2' ); ?>" border="0" width="100%"/></a></p>
		<?php endif; ?>
...
<?
		...
		<p class="img_box clear_left"><a href="<? echo gr_get_image_src('seko_img'); ?>" rel="lightbox[seko]" ><? echo gr_get_image( 'seko_img', array( 'width' => 300) ); ?></a></p>
		<? }
		if(post_custom('seko_img2')){ ?>
		<p class="img_box"><a href="<? echo gr_get_image_src('seko_img2'); ?>" rel="lightbox[seko]" ><? echo gr_get_image( 'seko_img2', array( 'width' => 300) ); ?></a></p>
		<? }
		if(post_custom('seko_img3')){ ?>
		<p class="img_box"><a href="<? echo gr_get_image_src('seko_img3'); ?>" rel="lightbox[seko]" ><? echo gr_get_image( 'seko_img3', array( 'width' => 300) ); ?></a></p>
		<? }
...
<?php if (is_object_in_term($post->ID, 'seko_staff','5819')): ?>
<p class="img_box"><a href="http://www.e-monte.co.jp/staff/5819.html"><img width="100" height="100" src="http://www.e-monte.co.jp/wp-content/uploads/2015/08/tamura_rollout-150x150.jpg" class="attachment-100x200" alt="tamura_rollout" /><br />田村　亘</a></p>
<?php endif; ?>
	...
	<!--
		...
		if($bnr){
			...
			foreach($bnr_group as $bnr_group):
				...
				?>
				<li<? if($i%1==0){echo ' class="clear_left"';} ?>><? if($url){echo '<a href="' . $url . '">';} ?><img src="/wp-content/themes/gaiheki/page_image/seko_bnr_<? echo $img; ?>_rollout.jpg" width="250" height="70" alt="<? echo $bnr_group ?>" /><? if($url){echo "</a>";} ?></li>
		<?
		$i++;
		endforeach;
			echo "</ul>";
...
-->
		...
		<div class="customer_navi_c clearfix">
			...
			<div class="page_back_btn02">
				<p class="page_back_text02"><a href="<?php echo get_post_type_archive_link( 'seko' ); ?>">一覧に戻る</a></p>
			</div>
...
<div class="tel">
		...
		<p><a href="tel:050-7302-3462"><img src="http://www.e-monte.co.jp/wp-content/themes/sp/images/tel-img.png"></a></p>
	</div>
<br>
<br>
<br>
